    ...
    <div class="flex h-screen">
                ...
                <nav class="mt-5 flex-1 px-2 space-y-1" role="navigation" aria-label="Sidebar">
                    ...
                    <?php if(auth()->user()->hasRole('student') && strtolower(auth()->user()->email) !== strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com')))): ?>
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('schedule.index')); ?>" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md <?php echo e(request()->routeIs('schedule.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900'); ?>">
                    ...
                    <?php if(strtolower(auth()->user()->email) !== strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com')))): ?>
                        <div class="space-y-1">
                            <div class="px-2 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider">Jadwal</div>
                            
                            <a href="<?php echo e(route('schedule.index')); ?>" class="group flex items-center text-sm font-medium rounded-md <?php echo e(request()->routeIs('schedule.*') ? 'text-blue-900' : ''); ?>" aria-current="<?php echo e(request()->routeIs('schedule.*') ? 'page' : 'false'); ?>">
                                <i class="sb-icon fas fa-calendar-check"></i>
                                Jadwal Absensi
                            </a>
                        </div>
                    ...
                    <?php if(auth()->user()->hasRole('admin') && strtolower(auth()->user()->email) !== strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com')))): ?>
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('admin.holidays.index')); ?>" class="group flex items-center text-sm font-medium rounded-md <?php echo e(request()->routeIs('admin.holidays.*') ? 'text-blue-900' : ''); ?>">
                                <i class="sb-icon fas fa-calendar-times"></i>
                                Kelola Hari Libur
                            </a>
                            
                            <a href="<?php echo e(route('admin.special-schedules.index')); ?>" class="group flex items-center text-sm font-medium rounded-md <?php echo e(request()->routeIs('admin.special-schedules.*') ? 'text-blue-900' : ''); ?>">
        ...
        <div class="sidebar-rail hidden md:flex md:flex-col bg-white border-r border-gray-200" aria-label="Collapsed Sidebar" style="width:56px">
            <div class="pt-5 flex flex-col items-center space-y-3">
                ...
                <a href="<?php echo e(route('schedule.index')); ?>" class="rail-item text-gray-500 hover:text-gray-800" title="Jadwal Absensi" aria-label="Jadwal Absensi">
                    <i class="fas fa-calendar-check"></i>
                    <span class="rail-tooltip">Jadwal Absensi</span>
                </a>
                <?php if(auth()->user()->hasRole(['teacher','tu','bk','kesiswaan','admin','headmaster'])): ?>
                <a href="<?php echo e(route('attendance.index')); ?>" class="rail-item text-gray-500 hover:text-gray-800" title="Status Absensi" aria-label="Status Absensi">
                    <i class="fas fa-list-check"></i>
                    <span class="rail-tooltip">Status Absensi</span>
                </a>
                <a href="<?php echo e(route('attendance.check-in')); ?>" class="rail-item text-gray-500 hover:text-gray-800" title="Absensi Masuk" aria-label="Absensi Masuk">
                    <i class="fas fa-sign-in-alt"></i>
                    <span class="rail-tooltip">Absensi Masuk</span>
                </a>
                <a href="<?php echo e(route('attendance.check-out')); ?>" class="rail-item text-gray-500 hover:text-gray-800" title="Absensi Keluar" aria-label="Absensi Keluar">
                    <i class="fas fa-sign-out-alt"></i>
                    <span class="rail-tooltip">Absensi Keluar</span>
                </a>
                <?php if(auth()->user()->hasRole(['teacher','admin'])): ?>
                <a href="<?php echo e(route('attendance.student-scan')); ?>" class="rail-item text-gray-500 hover:text-gray-800" title="Scan Siswa" aria-label="Scan Siswa">
                    <i class="fas fa-qrcode"></i>
                    <span class="rail-tooltip">Scan Siswa</span>
                </a>
                <?php endif; ?>
                <a href="<?php echo e(route('attendance.reports')); ?>" class="rail-item text-gray-500 hover:text-gray-800" title="Laporan Absensi" aria-label="Laporan Absensi">
                    <i class="fas fa-chart-bar"></i>
                    <span class="rail-tooltip">Laporan</span>
                </a>
                <?php endif; ?>
                <?php if(auth()->user()->hasRole(['admin','headmaster'])): ?>
                <a href="<?php echo e(route('leave-requests.index')); ?>" class="rail-item text-gray-500 hover:text-gray-800" title="Izin & Cuti" aria-label="Izin & Cuti">
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            ...
            <div class="relative z-10 flex-shrink-0 flex h-16 bg-white shadow" role="banner">
                <a href="<?php echo e(route('dashboard')); ?>" aria-label="Dashboard" class="flex items-center justify-center px-4 border-r border-gray-200 text-gray-500 hover:text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 md:hidden min-h-[64px]">
            ...
            <!-- Announcement Bar -->
            <?php if(auth()->user()->school->tenantSettings && auth()->user()->school->tenantSettings->show_announcement && auth()->user()->school->tenantSettings->topbar_announcement): ?>
                <div class="bg-blue-50 border-b border-blue-200 px-4 py-2">
                    <div class="flex items-center justify-center">
                        <i class="fas fa-bullhorn text-blue-600 mr-2"></i>
                        <p class="text-sm text-blue-800 text-center"><?php echo e(auth()->user()->school->tenantSettings->topbar_announcement); ?></p>
                    </div>
                </div>
            <?php endif; ?>
