        ...
        <div class="hidden md:flex md:w-64 md:flex-col">
            <div class="flex flex-col flex-grow pt-5 bg-white overflow-y-auto border-r border-gray-200">
                ...
                <nav class="mt-5 flex-1 px-2 space-y-1">
                    ...
                    <a href="{{ $isSuper ? route('super-admin.index') : route('dashboard') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs($isSuper ? 'super-admin.index' : 'dashboard') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                    ...
                    @if($isSuper)
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('super-admin.schools.index') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('super-admin.schools.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                <i class="fas fa-school mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                Manajemen Sekolah
                            </a>
                            
                            <a href="{{ route('super-admin.audit-trails.index') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('super-admin.audit-trails.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                <i class="fas fa-history mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                Audit Trail
                            </a>
                            
                            <a href="{{ route('super-admin.security.index') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('super-admin.security.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                ...
                <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                    ...
                    <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        ...
                        <nav class="mt-5 px-2 space-y-1">
                            @php($isSuper = strtolower(auth()->user()->email) === strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com'))))
                            <a href="{{ $isSuper ? route('super-admin.index') : route('dashboard') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs($isSuper ? 'super-admin.index' : 'dashboard') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                <i class="fas fa-home mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                Dashboard
                            </a>
                            ...
                            @if($isSuper)
                                <div class="mt-3 space-y-1">
                                    <div class="px-2 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider">Super Admin</div>
                                    <a href="{{ route('super-admin.schools.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('super-admin.schools.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-school mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Manajemen Sekolah
                                    </a>
                                    <a href="{{ route('super-admin.audit-trails.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('super-admin.audit-trails.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-history mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Audit Trail
                                    </a>
                                    <a href="{{ route('super-admin.security.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('super-admin.security.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-shield-alt mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Security Monitoring
                                    </a>
                                    <a href="{{ route('super-admin.security.banned-ips') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('super-admin.security.banned-ips') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-ban mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Banned IPs
                                    </a>
                                    <a href="{{ route('super-admin.network.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('super-admin.network.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-network-wired mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Network Monitoring
                                    </a>
                                </div>
                            ...
                            @if(auth()->user()->hasRole('admin') && strtolower(auth()->user()->email) !== strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com'))))
                                <div class="mt-3 space-y-1">
                                    <div class="px-2 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider">Manajemen Data</div>
                                    <a href="{{ route('users.index', ['type' => 'employee']) }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('users.*') && request('type') == 'employee' ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-user-tie mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Data Pegawai
                                    </a>
                                    <a href="{{ route('users.create', ['type' => 'employee']) }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('users.create') && request('type') == 'employee' ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-user-plus mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Tambah Pegawai
                                    </a>
                                    <a href="{{ route('users.index', ['type' => 'student']) }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('users.*') && request('type') == 'student' ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-user-graduate mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Data Siswa
                                    </a>
                                    <a href="{{ route('users.create', ['type' => 'student']) }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('users.create') && request('type') == 'student' ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-user-plus mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Tambah Siswa
                                    </a>
                                </div>
                            ...
                            @if(auth()->user()->hasRole(['teacher', 'tu', 'bk', 'kesiswaan', 'admin', 'headmaster']) && strtolower(auth()->user()->email) !== strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com'))))
                                <div class="mt-3 space-y-1">
                                    <div class="px-2 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider">Absensi</div>
                                    <a href="{{ route('attendance.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('attendance.index') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-calendar-check mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Status Absensi
                                    </a>
                                    @if(auth()->user()->hasRole(['teacher', 'tu', 'bk', 'kesiswaan', 'admin']))
                                        <a href="{{ route('attendance.check-in') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('attendance.check-in') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                            <i class="fas fa-sign-in-alt mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                            Absensi Masuk
                                        </a>
                                        <a href="{{ route('attendance.check-out') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('attendance.check-out') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                            <i class="fas fa-sign-out-alt mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                            Absensi Keluar
                                        </a>
                                        @if(auth()->user()->hasRole('teacher'))
                                            <a href="{{ route('attendance.student-scan') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('attendance.student-scan') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                                <i class="fas fa-qrcode mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                                Scan Siswa
                                            </a>
                                        @endif
                                    @endif
                                    <a href="{{ route('attendance.reports') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('attendance.reports') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-chart-bar mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Laporan Absensi
                                    </a>
                                </div>
                            ...
                            @if(auth()->user()->hasRole(['teacher', 'tu', 'bk', 'kesiswaan', 'admin', 'headmaster']) && strtolower(auth()->user()->email) !== strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com'))))
                                <div class="mt-3 space-y-1">
                                    <div class="px-2 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider">Izin & Cuti</div>
                                    <a href="{{ route('leave-requests.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('leave-requests.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-calendar-times mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        @if(auth()->user()->hasRole('headmaster'))
                                            Persetujuan Izin
                                        @else
                            ...
                            @if(auth()->user()->hasRole('admin') && strtolower(auth()->user()->email) !== strtolower(config('app.super_admin_email', env('APP_SUPER_ADMIN_EMAIL', 'superadmin@presensia.com'))))
                                <div class="mt-3 space-y-1">
                                    <div class="px-2 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider">Pengaturan</div>
                                    <a href="{{ route('settings.attendance') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('settings.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-cog mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Pengaturan Absensi
                                    </a>
                                    <a href="{{ route('qr.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('qr.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-qrcode mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        QR Code Management
                                    </a>
                                    <a href="{{ route('admin.roles.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('admin.roles.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-shield-alt mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Manajemen Role
                                    </a>
                                    <a href="{{ route('admin.permissions.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('admin.permissions.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-key mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Manajemen Permission
                                    </a>
                                    <a href="{{ route('tenant.settings') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('tenant.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                        <i class="fas fa-palette mr-3 text-gray-400 group-hover:text-gray-500"></i>
                                        Kustomisasi Aplikasi
                                    </a>
                                </div>
