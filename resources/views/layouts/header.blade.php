             ...
             <ul class="nav-menus">
                     ...
                     <div class="cart-dropdown onhover-show-div">
                         ...
                         <ul>
                             ...
                             <li class="text-center"><a class="d-block view-cart f-w-700 btn btn-primary w-100"
                                     href="javascript:void(0)">View Cart</a><a
                 ...
                 <li class="profile-nav onhover-dropdown pe-0 py-0">
                     ...
                     <ul class="profile-dropdown onhover-show-div">
                         <li><a href="javascript:void(0)"><i data-feather="user"></i><span>Account </span></a>
                         </li>
                         ...
                         <li><a href="javascript:void(0)"><i data-feather="log-in"> </i><span>Log out</span></a>
                         </li>
                     </ul>
                 </li>
             </ul>
