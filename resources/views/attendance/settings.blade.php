            ...
            <div class="px-4 py-5 sm:p-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="location_name" id="location_name" value="{{ old('location_name', $settings->location_name ?? 'Sekolah') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="radius_meters" id="radius_meters" min="10" max="1000" value="{{ old('radius_meters', $settings->radius_meters ?? 100) }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <input type="number" name="location_latitude" id="location_latitude" step="any" value="{{ old('location_latitude', $settings->location_latitude ?? '-6.200000') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('location_latitude')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div>
                        <label for="location_longitude" class="block text-sm font-medium text-gray-700">Longitude</label>
                        <input type="number" name="location_longitude" id="location_longitude" step="any" value="{{ old('location_longitude', $settings->location_longitude ?? '106.816666') }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('location_longitude')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                </div>
                <div class="mt-4">
            ...
            <div class="px-4 py-5 sm:p-6 border-b border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="qr_code_duration" id="qr_code_duration" min="5" max="60" value="{{ old('qr_code_duration', $settings->qr_code_duration ?? 10) }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('qr_code_duration')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                </div>
            </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center">
                        <input type="checkbox" name="require_photo" id="require_photo" value="1" {{ old('require_photo', $settings->require_photo ?? true) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <label for="require_photo" class="ml-2 block text-sm text-gray-900">Wajib foto selfie saat absensi</label>
                    </div>
                    <div class="flex items-center">
                        <input type="checkbox" name="require_location" id="require_location" value="1" {{ old('require_location', $settings->require_location ?? true) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        <label for="require_location" class="ml-2 block text-sm text-gray-900">Wajib lokasi GPS saat absensi</label>
                    </div>
                </div>
            </div>
    ...
    document.getElementById('getCurrentLocation')?.addEventListener('click', function() {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                ...
                function(error) { alert('Tidak dapat mendapatkan lokasi: ' + error.message); }
            );
