            ...
            <div class="px-4 py-5 sm:p-6">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('attendance.export', ['month' => $month, 'year' => $year, 'type' => $type]) }}" 
                           class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                            <i class="fas fa-download mr-2"></i>
                            Download Excel
                        </a>
                        <a href="{{ route('attendance.export-detail', ['month' => $month, 'year' => $year, 'type' => $type]) }}" 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            @if($type === 'all')
                                                <div class="text-sm text-gray-500">
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $user->user_type === 'student' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800' }}">
                                                        {{ $userTypeLabel }}
                                                    </span>
                                                </div>
                                            @endif
                                ...
                                <td class="px-2 py-4 text-center">
                                    <div class="rounded-lg border-2 {{ $colorClass }} p-2 min-h-[60px] flex flex-col justify-center" 
                                         style="{{ in_array($status, ['sick', 'permit', 'duty', 'leave']) ? 'background-color: #fed7aa !important; color: #c2410c !important; border-color: #fdba74 !important;' : '' }}">
                                        @if($attendance)
                                            <div class="text-xs font-semibold text-center">{{ $statusLabel }}</div>
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-green-600">{{ $ontimeCount }}</div>
                    ...
                    <div class="text-center">
                        <div class="text-2xl font-bold text-yellow-600">{{ $sickCount }}</div>
