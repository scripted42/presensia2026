...
@section('title', 'Edit Role - Presensia')
        ...
        <div class="px-4 py-5 sm:p-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Ubah permission untuk role ini</p>
                </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                @foreach($groupPermissions as $permission)
                                    <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer {{ $role->permissions->contains($permission->id) ? 'bg-blue-50 border-blue-300' : '' }}">
