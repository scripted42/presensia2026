    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Jadwal Khusus</h1>
                    <p class="text-gray-600 mt-1">Buat jadwal khusus untuk absensi (Upacara Senin, Rapat Guru, dll)</p>
                </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route('admin.special-schedules.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Jelaskan detail jadwal khusus ini">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="time" 
                               ...
                               value="{{ old('max_check_in_time', '07:30') }}"
                            ...
                            @foreach($roles as $roleKey => $roleName)
                                <label class="flex items-center">
                                    <input type="checkbox" 
                                           name="affected_roles[]" 
                                           value="{{ $roleKey }}"
                                           {{ in_array($roleKey, old('affected_roles', [])) ? 'checked' : '' }}
